...
class Following(spark: SparkSession) {
  ...
  /*
   * annot - Dataset of AQAnnotations, the ones we will be using to look for following sibling annotations. 
   * anchor - Dataset of AQAnnotations  starting point for using to look for following sibling annotations (use the endOffset and docId).
   * container - Dataset of AQAnnotations to use when requiring the following sibling annotations to be contained in a specific annotation.
